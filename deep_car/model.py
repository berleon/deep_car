...
def get_model(len_steering_hist, len_steering_delta, y_delta_buckets, input_size, n_mixtures=6, ):
    x = tf.placeholder(tf.float32, shape=[None, input_size[1], input_size[0], 1], name='image')
    ...
    return x, steering_hist, y_abs_true, y_delta_true, opt_op, \
