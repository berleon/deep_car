...
class DistNN:
    ...
    def __init__(self):
        ...
        saver = tf.train.import_meta_graph('../data/model/steering_model/steering_mixture_prob_exp.ckpt.meta')
        saver.restore(self.sess, tf.train.latest_checkpoint('../data/model/steering_model/'))
